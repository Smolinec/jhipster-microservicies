...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("JhipsterMicroservicies");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("JhipsterMicroservicies");
        ...
        config.getMapConfigs().put("cz.jirka.test.domain.*", initializeDomainMapConfig(jHipsterProperties));
