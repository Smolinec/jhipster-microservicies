...
class RoleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Role entity")
        ...
        .repeat(2) {
            ...
            .get("/services/jhipstermicroservicies/api/roles")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new role")
            .post("/services/jhipstermicroservicies/api/roles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/jhipstermicroservicies${new_role_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created role")
            .delete("/services/jhipstermicroservicies${new_role_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
