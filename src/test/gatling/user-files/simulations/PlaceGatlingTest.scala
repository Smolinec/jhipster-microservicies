...
class PlaceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Place entity")
        ...
        .repeat(2) {
            ...
            .get("/services/jhipstermicroservicies/api/places")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new place")
            .post("/services/jhipstermicroservicies/api/places")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "name":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/jhipstermicroservicies${new_place_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created place")
            .delete("/services/jhipstermicroservicies${new_place_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
