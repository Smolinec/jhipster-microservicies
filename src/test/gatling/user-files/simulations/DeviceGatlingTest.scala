...
class DeviceGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Device entity")
        ...
        .repeat(2) {
            ...
            .get("/services/jhipstermicroservicies/api/devices")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new device")
            .post("/services/jhipstermicroservicies/api/devices")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "uuid":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/jhipstermicroservicies${new_device_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created device")
            .delete("/services/jhipstermicroservicies${new_device_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
